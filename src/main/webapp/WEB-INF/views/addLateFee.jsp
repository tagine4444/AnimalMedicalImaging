...
<div class="container row">
		...
		<div class="span12">
			...
			<div class="span2">  
	  		...
	  		<div class="span2">  
	 			<label>Total</label>
		 		<form:input id ="amountId"  path="amount"  class="input-small" /> 
   			</div>
	  	...
	  	<div class="span12">
	  		<div class="span12">
		  		<button type="submit" name="addCharge" class="btn" >Add Late Fee</button>
		  	</div>	
	  	</div>
	  	</div>
</form:form>
	...
	<script type="text/javascript">
			function recaclculateMilageFee()
			{
 				...
 				var percentage = perAmount * dollarAmount / 100;
 				
 				tot = Number(perAmount) + Number(percentage);
